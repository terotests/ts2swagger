...
function bootstrap(app: any, server: serverFactory) {
  ...
  app.get('/sometest/v1/getDevice/:id/', async function( req, res ) {
    try {
  ...
  app.get('/sometest/v1/getDeviceSecond/', async function( req, res ) {
    try {
  ...
  app.get('/sometest/v1/recursiveTest/', async function( req, res ) {
    try {
